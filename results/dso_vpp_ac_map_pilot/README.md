> **Validity warning:** the unsuffixed Stage-0 outputs in this directory were generated without the fixed 850 kW reference-PV term and are invalid for scientific use. The invalid evidence was preserved at `_archived_stage0_missing_reference_pv_20260730T145810Z/`. Use only the explicitly suffixed corrected artifacts listed in `RESULT_STATUS.md`, and only for repair regression—not as a production hosting-capacity map.
